...
class TestDiagonalOperations(unittest.TestCase):
    """
    This class implements the unit tests for the diagonal-related matrix operations.
    ...
    def test_get_diagonal_square_matrix(self):
        ...
        np.testing.assert_array_equal(get_diagonal(matrix), expected_output)
